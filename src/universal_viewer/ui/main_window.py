...
class MainWindow(QMainWindow):
    ...
    def _create_central_widget(self) -> None:
        ...
        self._splitter.setChildrenCollapsible(
            False
        )

        self.file_browser.setMinimumWidth(
            400
        )

        self.viewer_stack.setMinimumWidth(
            400
        )
    ...
    def _connect_actions(self) -> None:
        ...
        self.menu.open_folder_action.triggered.connect(
            self._open_folder
        )
        ...
        self.menu.copy_action.triggered.connect(
            self._copy
        )

        self.menu.cut_action.triggered.connect(
            self._cut
        )

        self.menu.paste_action.triggered.connect(
            self._paste
        )
        
        self.menu.rename_action.triggered.connect(
            self.file_browser.rename_selected
        )
    
        self.menu.delete_action.triggered.connect(
            self.file_browser.delete_selected
        )
    
        self.menu.select_all_action.triggered.connect(
        ...
        self.menu.refresh_action.triggered.connect(
            self._refresh
        )

        self.menu.go_up_action.triggered.connect(
            self._go_up
        )
    ...
    def _open_folder(self) -> None:
        ...
        self.file_browser.set_root_path(
            folder
        )
    ...
    def _copy(self) -> None:
        ...
        self.status.showMessage(
            f"Copied {len(valid_paths)} item(s)"
        )
    ...
    def _setup_keyboard_shortcuts(self) -> None:
        ...
        self.menu.cut_action.setShortcutContext(
        ...
        self.menu.copy_action.setShortcutContext(
            Qt.ApplicationShortcut
        )
        ...
        self.menu.paste_action.setShortcutContext(
            Qt.ApplicationShortcut
        )
        ...
        self.menu.rename_action.setShortcutContext(
            Qt.WindowShortcut
        )
        ...
        self.menu.delete_action.setShortcutContext(
            Qt.WindowShortcut
        )
        ...
        self.menu.select_all_action.setShortcutContext(
            Qt.WindowShortcut
        )
